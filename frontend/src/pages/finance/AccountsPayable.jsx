...
import { AlertCircle, Building2, Clock, CreditCard, FileText, IndianRupee, RefreshCw } from "lucide-react";
  ...
  const columns = [
    ...
    { key: "actions", label: "Actions", sortable: false, render: (r) => (
      <RowActionMenu
        ...
        items={[
          { label: "Record Payment", icon: <CreditCard className="h-4 w-4" />, onClick: () => {} },
        ]}
      />
    )},
  ];
